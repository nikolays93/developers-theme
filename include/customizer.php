  ...
  function print_settings( $wp_customize ) {
    ...
    $wp_customize->add_control(
      ...
      array(
        ...
        'description' => 'После изменения стилей обновите страницу, чтобы предпроцессор скомпилировал стили. Прежде отключения удалите style.css, а comiled.css переменуйте в него.',
        'type'     => 'checkbox',
      )
    );
